...
/*
  ...
  +----------------------------------------------------------------------+
  $Id: VerifyContactsIntegrity.class.php,v 1.1 2012/05/30 23:49:36 Alberto Santos Exp $
*/
 ...
 * 
 *  /VerifyContactsIntegrity            application/json
 *      GET     devuelve un hash md5 de la serialización en json del arreglo de contactos en el servidor
 *              pero sólo con los campos especificados por el cliente por GET
 *
 */

class VerifyContactsIntegrity
{
    ...
    function URIObject()
    {
	$uriObject = new VerifyContactsIntegrityBase();
...
class VerifyContactsIntegrityBase extends REST_Resource
{
    function HTTP_GET()
    {
	...
	$result = $pCore_AddressBook->getHash($fields);
	if($result === FALSE){
