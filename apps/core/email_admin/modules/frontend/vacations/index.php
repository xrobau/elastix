...
function createForm(){
    $arrForm = array("CID_NAME"        => array("LABEL"                  => _tr("CID NAME:"),
                                  ...
                                  "FROM"  => array("LABEL"               => _tr("From:"),
												"REQUIRED"               => "no",
												"INPUT_TYPE"             => "TEXT",
												"INPUT_EXTRA_PARAM"      => array("id"=>"inputFrom", "class" => "form-control input-sm", "placeholder" => "2013-01-01"),
												"VALIDATION_TYPE"        => "text",
												"VALIDATION_EXTRA_PARAM" => ""),
                                    "TO"  => array("LABEL"               => _tr("To:"),
												"REQUIRED"               => "no",
												"INPUT_TYPE"             => "TEXT",
												"INPUT_EXTRA_PARAM"      => array("id"=>"inputTo", "class" => "form-control input-sm", "placeholder" => "2013-01-01"),
												"VALIDATION_TYPE"        => "text",
												"VALIDATION_EXTRA_PARAM" => ""),
                  "EMAIL_ADDRESS"   => array( "LABEL"                    => _tr("Email Addres:"),
												...
												"VALIDATION_EXTRA_PARAM" => ""),  
                           "EMAIL_SUBJECT"  => array("LABEL"               => _tr("Fax Subject:"),
												"REQUIRED"               => "no",
												"INPUT_TYPE"             => "TEXT",
												"INPUT_EXTRA_PARAM"      => array("class" => "form-control input-sm", "placeholder" => "12345"),
												"VALIDATION_TYPE"        => "text",
												"VALIDATION_EXTRA_PARAM" => ""),
                           "EMAIL_CONTENT"  => array("LABEL"               => _tr("Fax content:"),
												"REQUIRED"               => "no",
												"INPUT_TYPE"             => "TEXTAREA",
												"INPUT_EXTRA_PARAM"      => array("class" => "form-control input-sm", "placeholder" => "12345"),
												"VALIDATION_TYPE"        => "text",
