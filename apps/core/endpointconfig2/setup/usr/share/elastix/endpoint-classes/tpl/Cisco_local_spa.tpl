<flat-profile>
    ...
    <Resync_At_Random_Delay ua="na">1200</Resync_At_Random_Delay>    
...
<!-- Additional -->
    ...
    <Text_Logo ua="na">CiscoSPA</Text_Logo>
    <Select_Background_Picture ua="ua">BMP Picture</Select_Background_Picture>
    <BMP_Picture_Download_URL ua="ua">tftp://{{server_ip}}/CiscoSPA.bmp</BMP_Picture_Download_URL>
...
{{py:n = 1}}{{for extension in sip}}
    ...
    <Display_Name_{{n}}_ ua="na">{{extension.description}}</Display_Name_{{n}}_>
    <Short_Name_{{n}}_ ua="na">{{extension.extension}}</Short_Name_{{n}}_> 
    <User_ID_{{n}}_ ua="na">{{extension.account}}</User_ID_{{n}}_>
    <Password_{{n}}_ ua="na">{{extension.secret}}</Password_{{n}}_>
	<Dial_Plan_{{n}}_ ua="na">(*xx|*xxx|*xxxx|**xx|**xxx|xx*|xxx*|xxxx*|xxx**|*xxxxx|[3469]11|0|00|[2-9]xxxxxx|1xxx[2-9]xxxxxx|xxxxxxxxxxxx.)</Dial_Plan_{{n}}_>
{{py:n += 1}}{{endfor}}
</flat-profile>
