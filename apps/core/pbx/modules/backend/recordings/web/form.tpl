    ...
    <tr>
		...
		<tr class="letra12">
	     ...
	     <tr class="letra12" id='record_option_exten'>
                ...
                <td align="left">
                    <input size='30' name="on_extension" id="on_extension" type="text" value="{$EXTENSION}" style="padding-left:1%" />
		</td>
	    </tr>
		...
		<td colspan="2">
		  ...
		  <div id="clock1" >
			...
			<img src="modules/recordings/images/record.png" width="18px"/>
			...
			<img src="modules/recordings/images/stop.png" width="18px" />
