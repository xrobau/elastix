...
class paloSantoTC extends paloAsteriskDB{
    ...
    function getNumTC($domain=null){
        ...
        $query="SELECT count(id) from time_conditions $where";
    ...
    function getTCs($domain=null){
        ...
        $query="SELECT id,name,(SELECT tg.name from time_group tg where tg.id=id_tg) as tg_name,id_tg,destination_m,destination_f,organization_domain from time_conditions $where";
    ...
    function getTCById($id){
        ...
        $result=$this->_DB->getFirstRowQuery($query,true,array($id,$domain));
    ...
    function updateTCPBX($arrProp){
        ...
        $this->domain=$TC["organization_domain"];
