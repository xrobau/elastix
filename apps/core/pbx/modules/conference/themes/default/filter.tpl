...
<table width="99%" border="0" cellspacing="0" cellpadding="4" align="center">
    <tr class="letra12">
        <td width="3%" align="right">{$state_conf.LABEL}: </td>
        <td width="10%" align="left" nowrap>{$state_conf.INPUT}</td>
        <td width="5%" align="right">{$name_conf.LABEL}: </td>
        <td width="10%" align="left" nowrap>{$name_conf.INPUT}</td>
        <td align="left"><input class="button" type="submit" name="show" value="{$SHOW}"></td>
    </tr>
    <tr class="letra12">
        <td width="3%" align="right">{$type_conf.LABEL}: </td>
        <td width="10%" align="left" nowrap>{$type_conf.INPUT}</td>
    </tr>
</table>
{/if}