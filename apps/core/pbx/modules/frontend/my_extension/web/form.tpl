    ...
    <div class="my_settings">
       <div class="row">
        ...
        <div class="row elx-modules-content">
            <div class="row">
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3"><label>{$DISPLAY_NAME_LABEL}</label></div>
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3"><p>{$clid_name}</p></div>
            </div>

            <div class="row">
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3"><label>{$DISPLAY_EXT_LABEL}</label></div>
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3"><p>{$extension}</p></div>
            </div>

            <div class="row">
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3"><label>{$DISPLAY_DEVICE_LABEL}</label></div>
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3"><p>{$device}</p></div>
            </div>

            <div class="row">
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3"><label>{$language_vm.LABEL}</label></div>
            ...
            <div class="row" >
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3"><label>{$doNotDisturb.LABEL}</label></div>
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3" id="radio_do_not_disturb">{$doNotDisturb.INPUT}</div>
            </div>

            <div class="row" >
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3"><label>{$callWaiting.LABEL}</label></div>
            ...
            <div class="row" >
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3"><label>{$callForwardOpt.LABEL}</label></div>
            ...
            <div class="row" >
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3"><label>{$callForwardUnavailableOpt.LABEL}</label></div>
            ...
            <div class="row" >
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3"><label>{$callForwardBusyOpt.LABEL}</label></div>
            ...
            <div class="row" >
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3"><label>{$recordIncoming.LABEL}</label></div>
                <div class="col-xs-12 col-sm-5 col-md-4 col-lg-3" id="radio_record_incoming">{$recordIncoming.INPUT}</div>
            </div>

            <div class="row" >
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3"><label>{$recordOutgoing.LABEL}</label></div>
            ...
            <div class="row" >
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3"><label>{$status_vm.LABEL}</label></div>
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3" id="radio_status">{$status_vm.INPUT}</div>
            </div>

            <div class="row" >
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3"><label>{$email_vm.LABEL}</label></div>
            ...
            <div class="row" >
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3"><label>{$password_vm.LABEL}</label></div>
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                    {$password_vm.INPUT}
                    <a href="#" class="glyphicon glyphicon-exclamation-sign hidden-tooltip" data-toggle="tooltip" data-placement="auto" title="" data-original-title="Just numeric characters are valid"></a>
                </div>
            ...
            <div class="row" >
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3"><label>{$emailAttachment_vm.LABEL}</label></div>
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3" id="radio_email_attachment">{$emailAttachment_vm.INPUT}</div>
            </div>

            <div class="row" >
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3"><label>{$playCid_vm.LABEL}</label></div>
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3" id="radio_play_cid">{$playCid_vm.INPUT}</div>
            </div>
        
            <div class="row" >
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3"><label>{$playEnvelope_vm.LABEL}</label></div>
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3" id="radio_play_envelope">{$playEnvelope_vm.INPUT}</div>
            </div>

            <div class="row" >
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3"><label>{$deleteVmail.LABEL}</label></div>
