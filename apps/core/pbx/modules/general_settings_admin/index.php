...
function _moduleContent(&$smarty, $module_name)
{
    ...
    include_once "modules/$module_name/libs/paloGeneralSettingsPBX.class.php";
    ...
    $content = "";
	 ...
	 switch($action){
		case "apply":
			$content = applyChanges($smarty, $module_name, $local_templates_dir, $pDB, $arrConf, $userAccount, $userLevel1);
            break;
        default: // view
            $content = viewGeneralSetting($smarty, $module_name, $local_templates_dir, $pDB, $arrConf, $userAccount, $userLevel1);
            break;
    }
    return $content;
}
...
function viewGeneralSetting($smarty, $module_name, $local_templates_dir, &$pDB, $arrConf, $userAccount, $userLevel1){
    $error = "";

    if($userLevel1!="superadmin"){
        $smarty->assign("mb_title", _tr("ERROR"));
        $smarty->assign("mb_message",_tr("You are not authorized to view this module. "));
        $arrForm = array();
...
function applyChanges($smarty, $module_name, $local_templates_dir, &$pDB, $arrConf, $userAccount, $userLevel1){
    $action = "";
    //conexion elastix.db
    ...
    if($userLevel1!="superadmin"){
        ...
        return viewGeneralSetting($smarty, $module_name, $local_templates_dir, $pDB, $arrConf, $userAccount, $userLevel1);
    }
...
function createIaxForm($arrLang){
    ...
    $arrFormElements = array("iax_delayreject"     => array("LABEL"                  => _tr("delayreject"),
                                                "DESCRIPTION"            => "For increased security against brute force password attacks enable 'delayreject' which will delay the sending of authentication reject for REGREQ or AUTHREP if there is a password",
                                                "REQUIRED"               => "no",
                                                "INPUT_TYPE"             => "SELECT",
                                                "INPUT_EXTRA_PARAM"      => $arrYesNo,
                                                "VALIDATION_TYPE"        => "text", //yes
                             ...
                             "iax_bindport"  => array("LABEL"                  => _tr("Bind Port"),
                                                "DESCRIPTION"            => "Port number to bind and listen for IAX message . Default is 4569. It is recommended to leave this blank",
                                                "REQUIRED"               => "no",
                                                "INPUT_TYPE"             => "TEXT",
                                                "INPUT_EXTRA_PARAM"      => "",
                            ...
                            "iax_bandwidth"  => array("LABEL"            => _tr("Bandwidth"),
                                                "DESCRIPTION"            => "Specify bandwidth of low, medium, or high to control which codecs are used in general",
                                                "REQUIRED"               => "no",
                                                "INPUT_TYPE"             => "SELECT",
                            ...
                            "iax_maxexpiry"  => array("LABEL"         => _tr("maxexpiry"),
                                                "DESCRIPTION"            => "Maximum amounts of time that IAX peers can request as\n a registration expiration interval (in seconds)",
                                                "REQUIRED"               => "no",
                                                "INPUT_TYPE"             => "TEXT",
                                                "INPUT_EXTRA_PARAM"      => array("style" => "width:200px"),
                            ...
                            "iax_minexpiry"  => array("LABEL"         => _tr("minexpiry"),
                                                "DESCRIPTION"            => "Minimum amounts of time that IAX peers can request as\n a registration expiration interval (in seconds)",
                                                "REQUIRED"               => "no",
                                                "INPUT_TYPE"             => "TEXT",
                                                "INPUT_EXTRA_PARAM"      => array("style" => "width:200px"),
                                                "VALIDATION_TYPE"        => "numeric", //60
...
function createVMForm($arrLang,$arrTz)
{
    ...
    $arrFormElements = array(
                            ...
                            "vm_moveheard"   => array("LABEL"               => _tr("Move Messages to Old"),
                                                    "DESCRIPTION"            => _tr("Move heard messages to the 'Old' folder automagically."),
                                                    "REQUIRED"               => "no",
                                                    "INPUT_TYPE"             => "SELECT",
                                                    "INPUT_EXTRA_PARAM"      => $arrYesNoU,
                                                    "VALIDATION_TYPE"        => "ereg",
