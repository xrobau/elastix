  ...
  <div class="tab" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="5px" class="tabForm">
            ...
            {foreach from=$localnetIP key=i item=prop}
                <tr class="sip_settings nat_param">
                    ...
                    {if $i eq 0}
                        <img src='modules/{$MODULE_NAME}/images/add1.png' title='Add' class="add_local" id="custom_sip"/>
                    {else}
                        <img src='modules/{$MODULE_NAME}/images/remove1.png' title='Remove' class="remove_local"/> 
                    {/if}
                    </td>
                </tr>
            {/foreach}
            ...
            {foreach from=$sipCustom key=i item=prop}
                <tr class="sip_settings" >
                    ...
                    {if $i eq 0}
                        <img src='modules/{$MODULE_NAME}/images/add1.png' title='Add' class="add_prop" id="custom_sip"/>
                    {else}
                        <img src='modules/{$MODULE_NAME}/images/remove1.png' title='Remove' class="remove_prop_sip"/> 
                    {/if}
                    </td>
                </tr>
            {/foreach}
    ...
    <div class="content" id="content_tab-3" style="padding-left: 8px;">
        <table width="100%" border="0" cellspacing="0" cellpadding="5px" class="tabForm">
            ...
            <tr class="iax_settings">
                <td >{$iax_codec.LABEL}: 
                <td colspan="3">{$sip_codec.INPUT}</td>
            </tr>
            <tr class="iax_settings">
            ...
            {foreach from=$iaxCustom key=i item=prop}
                <tr class="iax_settings" >
                    ...
                    {if $i eq 0}
                        <img src='modules/{$MODULE_NAME}/images/add1.png' title='Add' class="add_prop" id="custom_iax"/>
                    {else}
                        <img class="remove_prop_iax" src='modules/{$MODULE_NAME}/images/remove1.png' title='Remove'/> 
                    {/if}
                    </td>
                </tr>
            {/foreach}
