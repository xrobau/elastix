...
function createInputCustom(tech,module_name){
    ...
    comp +="<img class='remove_prop_"+tech+"' src='modules/"+module_name+"/images/remove1.png' title='Remove'/></td>"; 
    comp +="<tr>";
    return comp;
}
function createInputLocal(module_name){
    ...
    comp +="<img class='remove_local' src='modules/"+module_name+"/images/remove1.png' title='Remove'/></td>";
    comp +="<tr>";
    return comp;
}
