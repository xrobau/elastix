...
class paloSantoOutbound extends paloAsteriskDB{
    ...
    /**
        funcion que le devuelve la ruta dado su id. Ademas si el usuario que invoca a la funcion 
        no es superadmin valida que al ruta pertnzca a la misma organizacion que el usuario
    */
