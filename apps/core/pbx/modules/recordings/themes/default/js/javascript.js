...
{   hangup = "yes";
    ...
    var id = $("#cod").val();
    var arrAction        = new Array();
    var sound = "<span data-src='index.php?menu=recordings&action=download&id="+id+"&rawmode=yes' style='margin-left: 5px;top: 3px;position: relative; cursor:pointer;'><img src='modules/recordings/images/sound.png' width='16px'/></span>";
