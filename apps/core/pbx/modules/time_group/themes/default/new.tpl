...
<div id="test" style="display:none;">
    ...
    <div class="time">
        <ul class="ul_time">
            <li class="li_time"> <span class="name">{$Stime__.LABEL}: </span> <div style="display:inline; position:relative" class="sTime" id="Stime__"></div> - <div style="display:inline; position:relative" class="fTime" id="Ftime__"></div> <img id='remove_time' class="remove_tg" src='modules/{$MODULE_NAME}/images/remove1.png' title='Remove' /> </li>
        </ul>
    </div>
    <div class="day_w">
        <ul class="ul_day_w">
            <li class="li_day_w"> <span class="name">{$Sday_week__.LABEL}: </span>{$Sday_week__.INPUT} - {$Fday_week__.INPUT} <img id='remove_day_w' class="remove_tg" src='modules/{$MODULE_NAME}/images/remove1.png' title='Remove'/> </li>
        </ul>
    </div>
    <div class="day_m">
        <ul class="ul_day_m">
            <li class="li_day_m"> <span class="name">{$Sday_month__.LABEL}: </span>{$Sday_month__.INPUT} - {$Fday_month__.INPUT} <img id='remove_day_m' class="remove_tg"  src='modules/{$MODULE_NAME}/images/remove1.png' title='Remove'/> </li>
        </ul>
    </div>
    <div class="month">
        <ul class="ul_month">
            <li class="li_month"> <span class="name">{$Smonth__.LABEL}: </span>{$Smonth__.INPUT} - {$Fmonth__.INPUT} <img id='remove_month' class="remove_tg"  src='modules/{$MODULE_NAME}/images/remove1.png' title='Remove'/> </li>
        </ul>
    </div>
</div>
    ...
    <div id="1" class="div_tg">
        <div class="time">
            <ul class="ul_time">
                ...
                <img src='modules/{$MODULE_NAME}/images/add1.png' title='Add' class="add_tg" id="add_time" /></li>
            </ul>
        </div>
        <div class="day_w">
            <ul class="ul_day_w">
                <li class="li_day_w"> <span class="name">{$Sday_week__.LABEL}: </span>
                    ...
                    {foreach from=$dayWeek key=k item=v}
                        <option value="{$k}">{$v}</option>
                    {/foreach}
                    </select> <img src='modules/{$MODULE_NAME}/images/add1.png' title='Add' class="add_tg" id="add_day_w" />
                </li>
            </ul>
        </div>
        <div class="day_m">
            <ul class="ul_day_m">
                <li class="li_day_m"> <span class="name">{$Sday_month__.LABEL}: </span>
                    ...
                    {foreach from=$dayMonth key=k item=v}
                        <option value="{$k}">{$v}</option>
                    {/foreach}
                    </select> </select> <img src='modules/{$MODULE_NAME}/images/add1.png' title='Add' class="add_tg" id="add_day_m" /> 
                </li>
            </ul>
        </div>
        <div class="month">
            <ul class="ul_month">
                <li class="li_month"> <span class="name">{$Smonth__.LABEL}: </span>
                    ...
                    {foreach from=$MONTH key=k item=v}
                        <option value="{$k}">{$v}</option>
                    {/foreach}
                    </select> </select> <img src='modules/{$MODULE_NAME}/images/add1.png' title='Add' class="add_tg" id="add_month" />
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="time">
                ...
                {foreach from=$SHOUR.$i key=t item=time}
                    <li class="li_time"> <span class="name">{$Stime__.LABEL}: </span>
                        ...
                        {if $t eq 0}
                        <img src='modules/{$MODULE_NAME}/images/add1.png' title='Add' class="add_tg" id="add_time" />
                        {else}
                        <img id='remove_time' class="remove_tg" src='modules/{$MODULE_NAME}/images/remove1.png' title='Remove'/>
                        {/if}
                    </li>
                {/foreach}
                </ul>
                ...
                <ul class="ul_day_w">
                    {foreach from=$SDAY_W.$i key=d item=day}
                        <li class="li_day_w"> <span class="name">{$Sday_week__.LABEL}: </span>
                            ...
                            {if $d eq 0}
                            <img src='modules/{$MODULE_NAME}/images/add1.png' title='Add' class="add_tg" id="add_day_w" />
                            {else}
                            <img id='remove_day_w' class="remove_tg" src='modules/{$MODULE_NAME}/images/remove1.png' title='Remove'/> 
                            {/if}
                        </li>
                    {/foreach}
                </ul>
                ...
                <ul class="ul_day_m">
                    {foreach from=$SDAY_M.$i key=f item=date}
                        <li class="li_day_m"> <span class="name">{$Sday_month__.LABEL}: </span>
                            ...
                            {if $f eq 0}
                            <img src='modules/{$MODULE_NAME}/images/add1.png' title='Add' class="add_tg" id="add_day_m" />
                            {else}
                            <img id='remove_day_m' class="remove_tg" src='modules/{$MODULE_NAME}/images/remove1.png' 
                            title='Remove'/>
                            {/if}
                        </li>
                    {/foreach}
                ...
                <ul class="ul_month">
                    {foreach from=$SMONTH.$i key=m item=mon}
                        <li class="li_month"> <span class="name">{$Smonth__.LABEL}: </span>
                            ...
                            {if $m eq 0}
                            <img src='modules/{$MODULE_NAME}/images/add1.png' title='Add' class="add_tg" id="add_month" />
                            {else}
                            <img id='remove_month' class="remove_tg" src='modules/{$MODULE_NAME}/images/remove1.png' title='Remove'/> 
                            {/if}
                        </li>
                    {/foreach}
                </ul>
