...
INSERT INTO `model` (`max_accounts`, `static_ip_supported`, `dynamic_ip_supported`, `name`, `description`, `id_manufacturer`) VALUES
(9, 1, 1, "480i", "480i", (SELECT `id` FROM manufacturer WHERE `name` = "Aastra")),
(9, 1, 1, "480i CT", "480i CT", (SELECT `id` FROM manufacturer WHERE `name` = "Aastra")),
(1, 1, 1, "51i", "51i", (SELECT `id` FROM manufacturer WHERE `name` = "Aastra")),
(9, 1, 1, "53i", "53i", (SELECT `id` FROM manufacturer WHERE `name` = "Aastra")),
(9, 1, 1, "55i", "55i", (SELECT `id` FROM manufacturer WHERE `name` = "Aastra")),
(9, 1, 1, "57i", "57i", (SELECT `id` FROM manufacturer WHERE `name` = "Aastra")),
(9, 1, 1, "57i CT", "53i CT", (SELECT `id` FROM manufacturer WHERE `name` = "Aastra")),
(6, 1, 1, "6730i", "6730i", (SELECT `id` FROM manufacturer WHERE `name` = "Aastra")),
(6, 1, 1, "6731i", "6731i", (SELECT `id` FROM manufacturer WHERE `name` = "Aastra")),
(9, 1, 1, "6739i", "6739i", (SELECT `id` FROM manufacturer WHERE `name` = "Aastra")),
(9, 1, 1, "6755i", "6755i", (SELECT `id` FROM manufacturer WHERE `name` = "Aastra")),
(9, 1, 1, "6757i", "6757i", (SELECT `id` FROM manufacturer WHERE `name` = "Aastra")),
(1, 1, 1, "9112i", "9112i", (SELECT `id` FROM manufacturer WHERE `name` = "Aastra")),
(9, 1, 1, "9133i", "9133i", (SELECT `id` FROM manufacturer WHERE `name` = "Aastra")),
(9, 1, 1, "9143i", "9143i", (SELECT `id` FROM manufacturer WHERE `name` = "Aastra")),
(9, 1, 1, "9480i", "9480i", (SELECT `id` FROM manufacturer WHERE `name` = "Aastra")),
(9, 1, 1, "9480i CT", "9480i CT", (SELECT `id` FROM manufacturer WHERE `name` = "Aastra")),
(1, 1, 1, "AT320", "AT320", (SELECT `id` FROM manufacturer WHERE `name` = "Atcom")),
(3, 1, 1, "AT530", "AT530", (SELECT `id` FROM manufacturer WHERE `name` = "Atcom")),
(2, 1, 1, "AT610", "AT610", (SELECT `id` FROM manufacturer WHERE `name` = "Atcom")),
(3, 1, 1, "AT620", "AT620", (SELECT `id` FROM manufacturer WHERE `name` = "Atcom")),
(5, 1, 1, "AT640", "AT640", (SELECT `id` FROM manufacturer WHERE `name` = "Atcom")),
(1, 1, 1, "AT800", "AT800", (SELECT `id` FROM manufacturer WHERE `name` = "Atcom")),
(6, 1, 1, "Temporis IP800", "ALCATEL Temporis IP800", (SELECT `id` FROM manufacturer WHERE `name` = "Atlinks")),
(1, 1, 1, "310HD", "310HD", (SELECT `id` FROM manufacturer WHERE `name` = "AudioCodes")),
(4, 1, 1, "320HD", "320HD", (SELECT `id` FROM manufacturer WHERE `name` = "AudioCodes")),
(1, 0, 1, "7690", "7690", (SELECT `id` FROM manufacturer WHERE `name` = "Cisco")),
(1, 0, 1, "7906", "7906", (SELECT `id` FROM manufacturer WHERE `name` = "Cisco")),
(3, 0, 1, "7931", "7931", (SELECT `id` FROM manufacturer WHERE `name` = "Cisco")),
(2, 0, 1, "7940", "7940", (SELECT `id` FROM manufacturer WHERE `name` = "Cisco")),
(6, 0, 1, "7960", "7960", (SELECT `id` FROM manufacturer WHERE `name` = "Cisco")),
(6, 0, 1, "7961", "7961", (SELECT `id` FROM manufacturer WHERE `name` = "Cisco")),
(8, 0, 1, "7970", "7970", (SELECT `id` FROM manufacturer WHERE `name` = "Cisco")),
(8, 0, 1, "7971", "7971", (SELECT `id` FROM manufacturer WHERE `name` = "Cisco")),
(2, 1, 1, "D-3310", "D-3310", (SELECT `id` FROM manufacturer WHERE `name` = "Damall")),
(2, 1, 1, "LXP200", "LXP200", (SELECT `id` FROM manufacturer WHERE `name` = "Elastix")),
(8, 1, 1, "ES620", "ES620", (SELECT `id` FROM manufacturer WHERE `name` = "Escene")),
(2, 1, 1, "C56", "C56/C56P", (SELECT `id` FROM manufacturer WHERE `name` = "Fanvil")),
(3, 1, 1, "C58", "C58/C58P", (SELECT `id` FROM manufacturer WHERE `name` = "Fanvil")),
(4, 1, 1, "C60", "C60", (SELECT `id` FROM manufacturer WHERE `name` = "Fanvil")),
(5, 1, 1, "C62", "C62", (SELECT `id` FROM manufacturer WHERE `name` = "Fanvil")),
(1, 1, 1, "BT200", "BT200", (SELECT `id` FROM manufacturer WHERE `name` = "Grandstream")),
(2, 1, 1, "HT386", "HT386", (SELECT `id` FROM manufacturer WHERE `name` = "Grandstream")),
(1, 1, 1, "GXP280", "GXP280", (SELECT `id` FROM manufacturer WHERE `name` = "Grandstream")),
(2, 1, 1, "GXP1400", "GXP1400", (SELECT `id` FROM manufacturer WHERE `name` = "Grandstream")),
(2, 1, 1, "GXP1405", "GXP1405", (SELECT `id` FROM manufacturer WHERE `name` = "Grandstream")),
(2, 1, 1, "GXP1450", "GXP1450", (SELECT `id` FROM manufacturer WHERE `name` = "Grandstream")),
(4, 1, 1, "GXP2000", "GXP2000", (SELECT `id` FROM manufacturer WHERE `name` = "Grandstream")),
(6, 1, 1, "GXP2020", "GXP2020", (SELECT `id` FROM manufacturer WHERE `name` = "Grandstream")),
(4, 1, 1, "GXP2100", "GXP2100", (SELECT `id` FROM manufacturer WHERE `name` = "Grandstream")),
(6, 1, 1, "GXP2120", "GXP2120", (SELECT `id` FROM manufacturer WHERE `name` = "Grandstream")),
(6, 1, 1, "GXP2200", "GXP2200", (SELECT `id` FROM manufacturer WHERE `name` = "Grandstream")),
(3, 1, 1, "GXV3140", "GXV3140", (SELECT `id` FROM manufacturer WHERE `name` = "Grandstream")),
(3, 1, 1, "GXV3175", "GXV3175", (SELECT `id` FROM manufacturer WHERE `name` = "Grandstream")),
(1, 1, 1, "IP8802", "IP8802/8802A", (SELECT `id` FROM manufacturer WHERE `name` = "LG-ERICSSON")),
(2, 1, 1, "SPA841", "SPA841", (SELECT `id` FROM manufacturer WHERE `name` = "Linksys")),
(1, 1, 1, "SPA921", "SPA921", (SELECT `id` FROM manufacturer WHERE `name` = "Linksys")),
(1, 1, 1, "SPA922", "SPA922", (SELECT `id` FROM manufacturer WHERE `name` = "Linksys")),
(2, 1, 1, "SPA941", "SPA941", (SELECT `id` FROM manufacturer WHERE `name` = "Linksys")),
(4, 1, 1, "SPA942", "SPA942", (SELECT `id` FROM manufacturer WHERE `name` = "Linksys")),
(6, 1, 1, "SPA962", "SPA962", (SELECT `id` FROM manufacturer WHERE `name` = "Linksys")),
(2, 0, 1, "IP 301", "IP 301", (SELECT `id` FROM manufacturer WHERE `name` = "Polycom")),
(2, 0, 1, "IP 330/320", "IP 330/320", (SELECT `id` FROM manufacturer WHERE `name` = "Polycom")),
(2, 0, 1, "IP 430", "IP 430", (SELECT `id` FROM manufacturer WHERE `name` = "Polycom")),
(3, 0, 1, "IP 501", "IP 501", (SELECT `id` FROM manufacturer WHERE `name` = "Polycom")),
(4, 0, 1, "IP 550", "IP 550", (SELECT `id` FROM manufacturer WHERE `name` = "Polycom")),
(6, 0, 1, "IP 601", "IP 601", (SELECT `id` FROM manufacturer WHERE `name` = "Polycom")),
(34, 0, 1, "IP 650", "IP 650", (SELECT `id` FROM manufacturer WHERE `name` = "Polycom")),
(1, 1, 1, "SoundStation IP 4000", "SoundStation IP 4000", (SELECT `id` FROM manufacturer WHERE `name` = "Polycom")),
(1, 1, 1, "VSX7000A", "VSX7000A", (SELECT `id` FROM manufacturer WHERE `name` = "Polycom")),
(1, 1, 1, "SL75 WLAN", "SL75 WLAN", (SELECT `id` FROM manufacturer WHERE `name` = "Siemens")),
(4, 1, 1, "300", "300", (SELECT `id` FROM manufacturer WHERE `name` = "Snom")),
(12, 1, 1, "320", "320", (SELECT `id` FROM manufacturer WHERE `name` = "Snom")),
(12, 1, 1, "360", "360", (SELECT `id` FROM manufacturer WHERE `name` = "Snom")),
(12, 1, 1, "821", "snom821-SIP", (SELECT `id` FROM manufacturer WHERE `name` = "Snom")),
(9, 1, 1, "m9", "m9", (SELECT `id` FROM manufacturer WHERE `name` = "Snom")),
(2, 1, 1, "ST 2022", "ST 2022", (SELECT `id` FROM manufacturer WHERE `name` = "Thomson")),
(1, 1, 1, "ST 2030", "ST 2030", (SELECT `id` FROM manufacturer WHERE `name` = "Thomson")),
(2, 1, 1, "VI2006", "VI2006", (SELECT `id` FROM manufacturer WHERE `name` = "VOPTech")),
(3, 1, 1, "VI2007", "VI2007", (SELECT `id` FROM manufacturer WHERE `name` = "VOPTech")),
(4, 1, 1, "VI2008", "VI2008", (SELECT `id` FROM manufacturer WHERE `name` = "VOPTech")),
(2, 1, 1, "XP0100P", "XP0100P", (SELECT `id` FROM manufacturer WHERE `name` = "Xorcom")),
(3, 1, 1, "XP0120P", "XP0120P", (SELECT `id` FROM manufacturer WHERE `name` = "Xorcom")),
(2, 1, 1, "SIP-T20/T20P", "SIP-T20/T20P", (SELECT `id` FROM manufacturer WHERE `name` = "Yealink")),
(3, 1, 1, "SIP-T22/T22P", "SIP-T22/T22P", (SELECT `id` FROM manufacturer WHERE `name` = "Yealink")),
(3, 1, 1, "SIP-T26/T26P", "SIP-T26/T26P", (SELECT `id` FROM manufacturer WHERE `name` = "Yealink")),
(6, 1, 1, "SIP-T28/T28P", "SIP-T28/T28P", (SELECT `id` FROM manufacturer WHERE `name` = "Yealink")),
(4, 1, 1, "VP530", "VP530", (SELECT `id` FROM manufacturer WHERE `name` = "Yealink")),
(6, 1, 1, "SIP-T38G", "SIP-T38G", (SELECT `id` FROM manufacturer WHERE `name` = "Yealink")),
(1, 0, 1, "ZIP2x1", "Zultys ZIP 2x1", (SELECT `id` FROM manufacturer WHERE `name` = "Zultys")),
(1, 0, 1, "ZIP2x2", "Zultys ZIP 2x2", (SELECT `id` FROM manufacturer WHERE `name` = "Zultys"));
