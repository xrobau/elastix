      ...
      <td>
        <table cellSpacing="0" cellPadding="0" width="100%" border="0" height="76">
          <tr>
            ...
            {/if}
            {/foreach}
	    <td class="menuaftertab" align="right"><span><a class="register_link" style="color: {$ColorRegister}; cursor: pointer; font-weight: bold; font-size: 13px;" >{$Registered}</a></span>&nbsp;&nbsp;&nbsp;&nbsp;</td>
