  ...
  <table cellspacing=0 cellpadding=0 width="100%" border=0>
    <tr>
      <td>
	    ...
	    <td class="menuaftertab" align="right"><span><a class="register_link" style="color: {$ColorRegister}; cursor: pointer; font-weight: bold; font-size: 13px;" onclick="showPopupCloudLogin('{$Register}',540,460)">{$Registered}</a></span>&nbsp;&nbsp;&nbsp;&nbsp;</td>
