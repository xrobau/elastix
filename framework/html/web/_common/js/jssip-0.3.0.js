...
UA.prototype.loadConfig = function(configuration) {
  ...
  this.contact = {
    pub_gruu: null,
    temp_gruu: null,
    // TODO: this WILL fail if multiple ws_servers differ in scheme
    uri: new JsSIP.URI('sip', JsSIP.Utils.createRandomToken(8), settings.via_host, null, {transport: settings.ws_servers[0].scheme.toLowerCase()}),
