...
// Created: 	2001-01-08
// Ver:		$Id: jpgraph.php,v 1.1.1.1 2007/07/06 21:31:56 gcarrillo Exp $
//
...
///////////////////
            ...
            if($this->xscale->IsSpecified()) {
  //              echo "es especificada";
            }

            if($this->xscale->auto_ticks) {
    //            echo "si hay auto scale";
            }

            if(!$this->xscale->ticks->IsSpecified()) {
      //          echo "los ticks no han sido especificados";
            } else {
        //        echo "los ticks si han sido especificados";
            }
        }
	...
	$n = count($this->ynaxis); 
	for( $i=0; $i < $n; ++$i ) {
// OJO: Esta linea dibuja el eje vertical
	    $this->ynaxis[$i]->Stroke($this->xscale); 				
            //var_dump($this->ynaxis[$i]);
	}
