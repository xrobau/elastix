%define modname callcenter-softphone

Summary: Elastix Call Center Softphone
Name:    elastix-callcenter-softphone
Version: 2.0.0
Release: 15
License: GPL
...
%description
Elastix Call Center Softphone
 Version para Softphone, llamada reprogramada a un agente.
