...
Source0: %{modname}_%{version}-14.tgz
...
if [ $1 -eq 1 ]; then #install
  ...
  echo "create database call_center;" > /var/spool/elastix-mysqldbscripts/09-callcenter.sql
  cat /tmp/new_module/%{modname}/setup/call_center.sql   >> /var/spool/elastix-mysqldbscripts/09-callcenter.sql
  echo "GRANT SELECT, INSERT, UPDATE, DELETE ON call_center.* TO asterisk@localhost IDENTIFIED BY 'asterisk';" >> /var/spool/elastix-mysqldbscripts/09-callcenter.sql
...
%changelog
* Thu Jul 14 2011  Bruno Macias V. <bmacias@palosanto.com> 2.0.0-14vipvoip
- Rebranding, database process was changed.
