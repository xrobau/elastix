...
Source: elastix-vtigercrm-%{version}-6.tar.gz
...
if [ $1 -eq 1 ]; then #install
  ...
  if [ ! -d "/var/lib/mysql/vtigercrm510" ]; then #no existe la base
    ...
    echo "The vtigercrm510 database exists."
  fi
